						...
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide active">
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item activeMyAds" href="dashboard-my-ads.php">Dashboard My Ads</a></li>
									<li><a class="dropdown-item activeFavouriteAds" href="dashboard-favourite-ads.php">Dashboard Favourite Ads</a></li>
									<li><a class="dropdown-item activeArchivedAds" href="dashboard-archived-ads.php">Dashboard Archived Ads</a></li>
									<li><a class="dropdown-item activePendingAds" href="dashboard-pending-ads.php">Dashboard Pending Ads</a></li>
							...
							<li class="nav-item dropdown dropdown-slide @@pages">
								...
								<!-- Dropdown list -->
								<ul class="dropdown-menu">
									<li><a class="dropdown-item @@about" href="about-us.php">About Us</a></li>
      ...
      <div class="col-lg-4">
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              <li class="active"><a href="dashboard-my-ads.php"><i class="fa fa-user"></i> My Ads</a></li>
              <li><a href="dashboard-favourite-ads.php"><i class="fa fa-bookmark-o"></i> Favourite Ads
                  <span>5</span></a></li>
              <li><a href="dashboard-archived-ads.php"><i class="fa fa-file-archive-o"></i>Archived Ads
                  <span>12</span></a></li>
              <li><a href="dashboard-pending-ads.php"><i class="fa fa-bolt"></i> Pending Approval<span>23</span></a>
              </li>
                  ...
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      <li class="list-inline-item">
                        <a data-toggle="tooltip" data-placement="top" title="view" class="view" href="category.php">
                          <i class="fa fa-eye"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a class="edit" data-toggle="tooltip" data-placement="top" title="Edit" href="dashboard.php">
                          <i class="fa fa-pencil"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a class="delete" data-toggle="tooltip" data-placement="top" title="Delete" href="dashboard.php">
              ...
              <tr>
                ...
                <td class="action" data-title="Action">
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      <li class="list-inline-item">
                        <a href="category.php" data-toggle="tooltip" data-placement="top" title="View" class="view">
                          <i class="fa fa-eye"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
        ...
        <div class="pagination justify-content-center">
          <nav aria-label="Page navigation example">
            <ul class="pagination">
              ...
              <li class="page-item"><a class="page-link" href="dashboard.php">1</a></li>
              <li class="page-item active"><a class="page-link" href="dashboard.php">2</a></li>
              <li class="page-item"><a class="page-link" href="dashboard.php">3</a></li>
              <li class="page-item">
