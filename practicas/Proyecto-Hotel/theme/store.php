						...
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide active">
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item active" href="store.php">Store Single</a></li>
				...
				<div class="block">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6">
							<ul class="store-list">
								<li><a href="store.php">1 - 800 - Got - Junk?</a></li>
								<li><a href="store.php">1000 bulbs.com</a></li>
								<li><a href="store.php">180 packrat.com</a></li>
								<li><a href="store.php">3 day blinds</a></li>
							</ul>
						</div>
						<!-- Store List 02 -->
						<div class="col-md-3 col-sm-6">
