						...
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide active">
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item active" href="user-profile.php">User Profile</a></li>
	...
	<div class="container">
		<div class="row">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              <li><a href="index.php">Savings Dashboard</a></li>
              <li><a href="index.php">Saved Offer <span>(5)</span></a></li>
              <li><a href="index.php">Favourite Stores <span>(3)</span></a></li>
              <li><a href="index.php">Recommended</a></li>
            </ul>
          </div>
				</div>
			</div>
