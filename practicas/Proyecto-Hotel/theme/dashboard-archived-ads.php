						...
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide active">
								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item activePage" href="dashboard.php">Dashboard</a></li>
									...
									<li><a class="dropdown-item active" href="dashboard-archived-ads.php">Dashboard Archived Ads</a></li>
				...
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							...
							<li>
								<a href="index.php"><i class="fa fa-cog"></i> Logout</a>
							</li>
							<li>
			...
			<div class="col-lg-8">
									...
									<div class="">
										<ul class="list-inline justify-content-center">
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Edit" class="edit" href="dashboard-archived-ads.php">
													<i class="fa fa-clipboard"></i>
												</a>
											</li>
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Delete" class="delete" href="dashboard-archived-ads.php">
				...
				<div class="pagination justify-content-center">
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item">
								<a class="page-link" href="dashboard-archived-ads.php" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
									<span class="sr-only">Previous</span>
								</a>
							</li>
							<li class="page-item"><a class="page-link" href="dashboard-archived-ads.php">1</a></li>
							<li class="page-item active"><a class="page-link" href="dashboard-archived-ads.php">2</a></li>
							<li class="page-item"><a class="page-link" href="dashboard-archived-ads.php">3</a></li>
							<li class="page-item">
								<a class="page-link" href="dashboard-archived-ads.php" aria-label="Next">
