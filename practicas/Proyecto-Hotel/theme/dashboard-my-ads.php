						...
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide active">
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item active" href="dashboard-my-ads.php">Dashboard My Ads</a></li>
								...
								<td class="action" data-title="Action">
									<div class="">
										<ul class="list-inline justify-content-center">
											...
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Edit" class="edit" href="dashboard-my-ads.php">
													<i class="fa fa-pencil"></i>
												</a>
											</li>
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Delete" class="delete" href="dashboard-my-ads.php">
